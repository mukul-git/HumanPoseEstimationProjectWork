...
int main(int argc, char** argv)
{
	...
	Ptr<FeatureDetector> detector = cv::xfeatures2d::SurfFeatureDetector::create();
	Ptr<DescriptorExtractor> descriptorExtractor = cv::xfeatures2d::SurfDescriptorExtractor::create();
